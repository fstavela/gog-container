#!/bin/bash
GOG_GAMES_DIR=/home/$USER/games/gog-games
...
cp desktop-icons/airline-tycoon.desktop /home/$USER/.local/share/applications
sed -i "s/USER/$USER/" /home/$USER/.local/share/applications/airline-tycoon.desktop
echo Copied desktop-icons/airline-tycoon.desktop to /home/$USER/.local/share/applications/airline-tycoon.desktop to create desktop menu entry
